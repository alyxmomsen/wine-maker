...
export class VineyardFactory {
    ...
    createForPlayer(player: PlayerPerson, vineyardInventory: IInventory<IVineyard>): boolean {
        ...
        const newVineyard = new Vineyard(this.uniqIdRegistry.gen() ,randomName(4), playerCurrentLocation, player)
